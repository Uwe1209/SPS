  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name="LoginSelection" component={LoginSelection}></Stack.Screen>
        <Stack.Screen name="UserLogin" component={UserLogin}></Stack.Screen>
...
// Login Selection Page (Select User or Admin Login)
