...
output_dir = r"C:\Users\darklorddad\Downloads\Year 3 Semester 1\COS30049 Computing Technology Innovation Project\Project\SPS\iNaturalist\CSV\Protected\Rhododendron"
...
for year in range(2025, 1969, -1):
    ...
    try:
        ...
        file_path = os.path.join(output_dir, f"observations-rhododendron-{year}.csv")
